...
暂时不支持队列请求优先级设置。如果要想让一个请求优先,可以使用Rx线程单一请求。<br>
...
NoHttpDownloadUtils.getNoHttpDownloadBuild()
                    //添加下载文件参数
                   .addDownloadParameter(DOWNLOAD_URL, "Liqi_single_test.apk")
                   //设置是否断点续传下载
                   .setRange(true)
                   //设置下载进度监听接口
...
##### 如果觉得不错，请star给我动力。<br> <br> 非常感谢。<br> <br>If you feel good, please give me the star. <br><br>Thank you very much.
